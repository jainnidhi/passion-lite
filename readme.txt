...
Passion WordPress Theme, Copyright (C) 2014 IdeaBox Themes
Passion is distributed under the terms of the GNU GPL
...
Widgets are a great way of adding extra content to your site and Passion has a whole assortment of them.
...
Use the following instructions to install & activate Passion using your preferred method.

Manual installation:

1. Unzip the files from the Passion zip file that you downloaded
2. Upload the Passion folder to your /wp-content/themes/ directory
3. Click on the Appearance > Themes menu option in the WordPress Dashboard
4. Click the Activate link below the Passion preview thumbnail
...
Passion is licensed under the [GNU General Public License version 2](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html).
...
Passion WordPress Theme is derived from Underscores WordPress Theme, Copyright 2013 Automattic, Inc.
Passion WordPress Theme is distributed under the terms of the GNU GPL
...
Passion uses the following images licensed under Creative Commons public domain deed CC0
